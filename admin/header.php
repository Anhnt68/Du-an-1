            ...
            <div class="col-xl-9">
                <ul class="navbar-nav d-flex justify-content-end flex-row">
                    ...
                    <li class="nav-item d-flex flex-column mx-3"><i class="bi bi-person-circle fs-4 m-auto"></i> <a
                            href="" class="text-decoration-none text-dark">Tai
                            khoan</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-xl-2 bg-secondary min-vh-100">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item bg-secondary d-flex align-items-center"><i
                            class="bi bi-chat-dots-fill fs-3 px-4 text-light"></i><a
                            class="text-decoration-none fs-5 text-light" href="">Bình Luận</a>
                    </li>
