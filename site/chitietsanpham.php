...
<div class="container-fluid">
                    ...
                    <div class="area_order">
                        <div class="quanlity mb-4">
                            ...
                            <div class="buttons_added">
                                ...
                                <input id="this-item-quantity" class="input-qty" max="<?=$quantity?>" min="1" name="productQuantity"
                                    type="number" value="1" required value="1" />
                            </div>
                        ...
                        <div class="form-check mt-3">
                            <input class="form-check-input" type="radio" name="dungtich" value="100" id="defaultCheck1"
                                checked>
                            <label class="form-check-label" for="defaultCheck1">
                                100ml
                            </label>
    ...
    if (isset($_SESSION['account']['id']) && $_SESSION['account']['id'] > 0) {
        echo ' <input type="submit" name="addtocart" class="border-0 w-30 btn btn-danger p-2"
                            value="Thêm vào giỏ hàng">';
    } else {

        $link = 'http://localhost/du-an-1/index.php?act=dangnhap';
        echo "<button class='border-0 w-30 btn btn-danger'><a href='$link' target='_parent' class='text-decoration-none text-light'>Vui long dang nhap de mua hang</a></button>";
            ...
            <a href="/user?wishlist&add=275" class="add-to-wishlist is-css">
                <span class="icon js-product-gift-icon" data-placement="bottom" data-toggle="tooltip"
...
<div class="menu-content" style="padding: 0; margin: 20px 0">
    ...
    <div class="content tab-content" id="tab-1" style="
            ...
            ">
        <p style="text-align: justify;font-family: Arial, Helvetica, sans-serif; font-size: 14px;">
            <!-- mota -->
            <?= $desc_pro ?>
        </p>
    </div>
